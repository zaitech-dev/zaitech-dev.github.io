export const translations = {
  en: {
    ...
    companyMission: 'Scaling Technology Solutions Across Borders',
    missionDescription: 'We design, develop, and scale innovative technology solutions that drive business growth and operational excellence',
    aboutDescription: 'At Zaitech Development, we build comprehensive technology ecosystems that unify complex business operations into streamlined, intelligent platforms. Our solutions serve MVPDs, broadcasters, retail chains, and manufacturing industries, delivering automated workflows, real-time analytics, and cross-platform integration that drives operational excellence and revenue optimization.',
    ourApproach: 'Our Approach',
    approachDescription: 'We develop enterprise solutions that seamlessly bridge linear and digital operations while scaling across international markets. Our methodology focuses on unified platform development, automated workflow integration, and predictive analytics that transform how businesses operate. From campaign management systems processing hundreds of millions in revenue to pricing intelligence platforms serving major retail chains, we create technology that drives measurable business outcomes.',
    founderNote: 'Founded by Abdullah Zaiter',
    founderLink: 'Learn more about our founder',
    keyAchievements: 'Key Achievements',
    revenueImpact: 'Revenue Growth',
    revenueImpactDesc: 'Platforms generating tens of millions in revenue',
    systemScaling: 'System Scaling',
    systemScalingDesc: 'Infrastructure scaled from 10 to 230K+ active devices',
    globalReach: 'Global Reach',
    globalReachDesc: 'Multi-country platforms across 4+ markets',
    teamExpertise: 'Team Excellence',
    teamExpertiseDesc: 'Expert teams delivering enterprise solutions',
  ...
  ar: {
    ...
    // About Section
    aboutTitle: 'حول تطوير زايتك',
    companyMission: 'توسيع الحلول التقنية عبر الحدود',
    missionDescription: 'نصمم ونطور ونوسع حلول تقنية مبتكرة تحفز نمو الأعمال والتميز التشغيلي',
    aboutDescription: 'في تطوير زايتك، نبني أنظمة تقنية شاملة توحد العمليات التجارية المعقدة في منصات ذكية ومبسطة. حلولنا تخدم مزودي خدمات الفيديو والمذيعين وسلاسل البيع بالتجزئة وصناعات التصنيع، وتقدم سير عمل آلي وتحليلات في الوقت الفعلي وتكامل عبر المنصات يحقق التميز التشغيلي وتحسين الإيرادات.',
    ourApproach: 'نهجنا',
    approachDescription: 'نطور حلول المؤسسات التي تربط بسلاسة بين العمليات الخطية والرقمية مع التوسع عبر الأسواق الدولية. تركز منهجيتنا على تطوير المنصات الموحدة وتكامل سير العمل الآلي والتحليلات التنبؤية التي تحول طريقة عمل الشركات. من أنظمة إدارة الحملات التي تعالج مئات الملايين من الإيرادات إلى منصات ذكاء التسعير التي تخدم سلاسل التجزئة الكبرى، نبني تقنيات تحقق نتائج أعمال قابلة للقياس.',
    founderNote: 'تأسست على يد عبد الله زعيتر',
    ...
    systemScalingDesc: 'بنية تحتية وسعت من 10 إلى أكثر من 230 ألف جهاز نشط',
    globalReach: 'الوصول العالمي',
    globalReachDesc: 'منصات متعددة البلدان عبر أكثر من 4 أسواق',
    teamExpertise: 'تميز الفريق',
    teamExpertiseDesc: 'فرق خبيرة تقدم حلول المؤسسات',
    ...
    servicesDescription: 'حلول تقنية على مستوى المؤسسات مصممة لتوسيع أعمالك عالمياً',
