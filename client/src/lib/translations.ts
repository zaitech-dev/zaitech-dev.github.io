export const translations = {
  en: {
    ...
    approachDescription: 'We build unified platforms that bridge linear and digital operations across international markets. Our solutions integrate automated workflows with predictive analytics, transforming campaign management, pricing intelligence, and enterprise operations. Results: platforms processing hundreds of millions in revenue with measurable business impact.',
  ...
  ar: {
    ...
    ourApproach: 'نهجنا',
    approachDescription: 'نبني منصات موحدة تربط بين العمليات الخطية والرقمية عبر الأسواق الدولية. حلولنا تدمج سير العمل الآلي مع التحليلات التنبؤية، محولة إدارة الحملات وذكاء التسعير وعمليات المؤسسات. النتائج: منصات تعالج مئات الملايين من الإيرادات مع تأثير تجاري قابل للقياس.',
