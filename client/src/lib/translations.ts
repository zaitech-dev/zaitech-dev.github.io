export const translations = {
  en: {
    ...
    servicesDescription: 'Enterprise-grade technology solutions designed to accelerate your global business growth.',
    platformDevelopmentTitle: 'Platform Development',
    platformDevelopmentDesc: 'End-to-end development of robust e-commerce platforms, payment systems, and enterprise applications handling millions of transactions seamlessly.',
    systemScalingTitle: 'System Scaling & Optimization',
    systemScalingDesc: 'Proven results in infrastructure scaling, performance optimization, and expansion into multi-country markets.',
  ...
  ar: {
    ...
    // Hero Section
    heroTitle: 'زايتيك للتطوير ',
    heroSubtitle: 'رواد في هندسة البرمجيات',
    heroDescription: 'تطوير أنظمة السيرفرات، وتطبيقات الجوال، والأنظمة المدمجة',
    learnMore: 'اعرف المزيد',
    getInTouch: 'تواصل معنا',

    // About Section
    aboutTitle: 'حول زايتيك للتطوير ',
    companyMission: 'توسيع الحلول التقنية عالميًا',
    missionDescription: 'نصمم ونطور ونوسع حلولاً تقنية مبتكرة لتسريع نمو الأعمال وتحقيق التميز التشغيلي.',
    aboutDescription: 'في زايتيك للتطوير ، نبني أنظمة تقنية متكاملة تبسط العمليات التجارية المعقدة إلى منصات ذكية وميسرة. تخدم حلولنا مزودي الفيديو، والمذيعين، ومتاجر التجزئة، وصناعات التصنيع عبر سير عمل آلي وتحليلات فورية وتكامل متعدد المنصات، محققة تحسناً كبيراً في الكفاءة التشغيلية ونمو الإيرادات.',
    ourApproach: 'نهجنا',
    approachDescription: 'نطور منصات موحدة تربط بسلاسة بين العمليات الخطية والرقمية في الأسواق الدولية. تعتمد حلولنا على الأتمتة والتحليلات التنبؤية لإحداث تحول جذري في إدارة الحملات وذكاء التسعير والعمليات المؤسسية، مما ينتج منصات تدير إيرادات بمئات الملايين بتأثير ملموس.',
    ...
    systemScalingAchievementDesc: 'بنية تحتية توسعت من 10 إلى أكثر من 230 ألف جهاز نشط',
    globalReach: 'الانتشار العالمي',
    globalReachDesc: 'منصات متعددة البلدان في أكثر من 4 أسواق',
    teamExpertise: 'تميز الفريق',
    teamExpertiseDesc: 'فرق متخصصة تقدم حلولاً مؤسسية عالية المستوى',
    ...
    skillsDescription: 'تقنيات حديثة نعتمد عليها لتقديم حلول قابلة للتوسع.',
    ...
    // Footer
    footerCopyright: '© 2024 زايتيك للتطوير . جميع الحقوق محفوظة.',
  }
};
